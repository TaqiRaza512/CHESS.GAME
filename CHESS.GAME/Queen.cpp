#include "Queen.h"
#include"Piece.h"
Queen::Queen(Board* B, Position _P, COLOR _C):Piece(B, _P, _C)
{
	//sym = ((_C == Black) ? 'Q' : 'q');
}
...
void Queen::HighLight_The_Legal_Move(Board* B, Position S)
{
	Position D;
...
bool Queen::IsThereLegalMove(Board* B, Position S)
{
...
void Queen::Un_Highlight_The_Moves(Board* B, Position S, Position E)
{
	Position D;
	int colour;
	for (int ri = 0; ri < 8; ri++)
...
bool Queen::ISLEGAL(Board* B, Position S, COLOR C, Position  D)
{
